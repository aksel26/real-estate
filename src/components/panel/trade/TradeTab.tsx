  ...
  return (
    <div className="relative min-h-full">
      <div className="p-4 space-y-4">
        ...
        <AreaBandChips />
        <TradeRankList items={rankedApts} />
      </div>

      <AnimatePresence>
        {selectedApt && <TradeDetailContent key="trade-detail" item={selectedApt} />}
      </AnimatePresence>
    </div>
  );
}
